...
{
    /// <summary>
    /// MbActionAlter - Nhận Input của người chơi, đối với người chơi trên nền tảng Mobile.
    /// Tác giả: Nguyễn Ngọc Phú, Ngày tạo: 02/05/2025
    /// </summary>
    public class MbActionAlter : MonoBehaviour, IAction, IPointerDownHandler
    {
        ...
        {
            _playerController.States.IsAttacking = true;
        }
